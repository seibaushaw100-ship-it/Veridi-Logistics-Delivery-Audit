...
https://github.com/seibaushaw100-ship-it/Veridi-Logistics-Delivery-Audit
A. Executive Summary
...
The datasets were merged using common keys such as order_id and customer_id. Duplicate records were checked, missing values were handled appropriately, and date columns were converted to datetime format to support delivery performance calculations. Product categories were translated from Portuguese to English using the provided translation dataset.
Feature Engineering
...
•	GitHub 
Repository Contents
• Veridi_Logistics_Notebook.ipynb
• Veridi_Logistics_Notebook.html (or PDF)
• Veridi_Logistics_Dashboard.pbix
• Dashboard_Screenshot.png
• Veridi_Logistics_Presentation.pdf
• README.md
Recommendations
